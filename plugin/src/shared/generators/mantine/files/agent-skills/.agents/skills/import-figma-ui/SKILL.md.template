...
description: >
  ...
  `@ronas-it/nx-generators` (`next-app --withMantine`). Use whenever asked to "import Figma UI",
...
Read `.agents/skills/import-figma-vars/SKILL.md` and follow it now. This is the first hand-off, so
...
Read `.agents/skills/import-figma-assets/SKILL.md` and follow it now, using the Figma link/access,
