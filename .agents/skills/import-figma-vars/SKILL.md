...
description: >
  ...
  was scaffolded with `@ronas-it/nx-generators` (`next-app --withMantine`); can run standalone or
  as the first phase of the `import-figma-ui` skill, which hands off here and reuses the Figma
  access and node IDs this skill locates for its own remaining phases (assets, theme, fonts).
---

# Import Figma variables

This file lives under `.agents/skills/import-figma-vars/`, following the [Agent Skills
...
Claude-Code-specific pointer to this file lives at `.claude/skills/import-figma-vars/SKILL.md`.
