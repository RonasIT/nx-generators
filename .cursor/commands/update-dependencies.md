...
Update dependencies of `apps/mobile` and `apps/web`, propagate versions into
`plugin/src/shared/dependencies.ts` and `plugin/package.json`, and verify the plugin is safe to
publish.
