...
export async function reactLibGenerator(tree: Tree, options: ReactLibGeneratorSchema): Promise<void> {
  ...
  // Remove autogenerated component https://github.com/nrwl/nx/blob/master/packages/expo/src/generators/library/library.ts#L116
  tree.delete(`${libPath}/src/lib`);
  tree.write(`${libPath}/src/index.ts`, '');
